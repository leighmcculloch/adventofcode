...
func countToPoint(input string, p point) int {
	count := 0
	x, y := mid, mid
	steps := strings.Split(input, ",")
	for _, step := range steps {
...
func main() {
	...
	for i, p := range points {
		steps := countToPoint(i1, p) + countToPoint(i2, p)
